...
botonResumen.addEventListener("click",
    function calcularDescuento() {
        ...
        let mensajeNombreCompleto = document.createElement("p")
        mensajeNombreCompleto.textContent = "Descuento a nombre de: " + nombre + " " + apellido + ". Será enviado al correo: " + correo + ". El costo de su viaje sin descuento: " + costo + ". Total a pagar es: $" + descuento
        contenedorNombre.appendChild(mensajeNombreCompleto);
